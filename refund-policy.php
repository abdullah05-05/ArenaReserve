...
<head>
    ...
    <title>Refund Policy — ArenaReserve</title>
    <!-- Tailwind CSS CDN -->
    ...
    <?php
    $page_description = 'ArenaReserve Refund Policy — Rules and timelines for wallet refunds, slot cancellations, and match challenge reimbursements.';
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="max-w-3xl">
                ...
                <p class="mt-4 text-base sm:text-lg text-slate-300 leading-relaxed font-normal">
                    Clear guidelines on refund eligibilities, reimbursement rates, wallet reconciliations, and dispute procedures on ArenaReserve.
                </p>
                <div class="mt-6 flex flex-wrap items-center gap-6 text-xs text-slate-400 font-medium">
                    <div class="flex items-center gap-2">
                        <span class="w-2 h-2 rounded-full bg-emerald-400"></span>
                        <span>Standard Refund Credit: Instant to ArenaReserve Wallet</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <span class="w-2 h-2 rounded-full bg-teal-400"></span>
                        <span>Dispute Resolution SLA: 24 to 48 Hours</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white border-b border-slate-200 sticky top-20 z-40 shadow-xs">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center space-x-1 sm:space-x-4 overflow-x-auto py-3 no-scrollbar text-sm font-semibold">
                ...
                <a href="refund-policy.php" class="px-4 py-2 rounded-xl bg-emerald-50 text-emerald-700 font-bold flex-shrink-0 flex items-center gap-2">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <aside class="hidden lg:block lg:col-span-3">
                    <div class="sticky top-40 bg-white p-6 rounded-2xl border border-slate-200 shadow-xs">
                        <h3 class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-4">Refund Highlights</h3>
                        <nav class="space-y-2 text-sm text-slate-600 font-medium">
                            <a href="#overview" class="block hover:text-emerald-600 transition-colors py-1">1. Policy Overview</a>
                            <a href="#direct-refunds" class="block hover:text-emerald-600 transition-colors py-1">2. Direct Booking Refunds</a>
                            <a href="#challenge-refunds" class="block hover:text-emerald-600 transition-colors py-1">3. Match Challenge Refunds</a>
                            <a href="#weather-refunds" class="block hover:text-emerald-600 transition-colors py-1">4. Weather & Force Majeure</a>
                            <a href="#method-timeline" class="block hover:text-emerald-600 transition-colors py-1">5. Payout Methods & Timeline</a>
                            <a href="#disputes" class="block hover:text-emerald-600 transition-colors py-1">6. Filing a Refund Dispute</a>
                        </nav>

                        <div class="mt-6 pt-6 border-t border-slate-100">
                            <div class="text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Refund Help Desk</div>
                ...
                <div class="lg:col-span-9 space-y-8">
                    ...
                    <!-- Section 1: Overview -->
                    <section id="overview" class="legal-card p-6 sm:p-8">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h2 class="text-xl sm:text-2xl font-bold text-slate-900">Refund Policy Overview</h2>
                        </div>
                        <p class="text-slate-600 text-sm sm:text-base leading-relaxed">
                            At ArenaReserve, we prioritize fair financial operations for both sports athletes and facility owners. Every ground booking involves holding prime venue calendar slots; hence, refunds are strictly automated and structured based on cancellation lead times and match confirmation states.
                        </p>
                    </section>

                    <!-- Section 2: Direct Booking Refunds Table -->
                    <section id="direct-refunds" class="legal-card p-6 sm:p-8">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h2 class="text-xl sm:text-2xl font-bold text-slate-900">Direct Booking Refund Schedule</h2>
                        </div>
                        <div class="overflow-x-auto">
                            <table class="min-w-full text-left text-sm border-collapse">
                                <thead>
                                    <tr class="bg-slate-50 border-b border-slate-200">
                                        <th class="py-3 px-4 font-bold text-slate-700">Cancellation Timeframe</th>
                                        <th class="py-3 px-4 font-bold text-slate-700">Player Refund %</th>
                                        <th class="py-3 px-4 font-bold text-slate-700">Owner Compensation</th>
                                        <th class="py-3 px-4 font-bold text-slate-700">Processing Time</th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y divide-slate-100">
                                    <tr>
                                        <td class="py-3.5 px-4 font-semibold text-slate-800">More than 24 hours prior to slot</td>
                                        <td class="py-3.5 px-4 text-emerald-600 font-bold">100% Full Refund</td>
                                        <td class="py-3.5 px-4 text-slate-500">None (Slot released for re-booking)</td>
                                        <td class="py-3.5 px-4 text-slate-600">Instant (Wallet)</td>
                                    </tr>
                                    <tr>
                                        <td class="py-3.5 px-4 font-semibold text-slate-800">Within 24 hours of slot</td>
                                        <td class="py-3.5 px-4 text-amber-600 font-bold">50% Partial Refund</td>
                                        <td class="py-3.5 px-4 text-slate-700 font-medium">95% of retained fee credited to Owner</td>
                                        <td class="py-3.5 px-4 text-slate-600">Instant (Wallet)</td>
                                    </tr>
                                    <tr>
                                        <td class="py-3.5 px-4 font-semibold text-slate-800">Past slot time or no-show</td>
                                        <td class="py-3.5 px-4 text-rose-600 font-bold">0% (Non-refundable)</td>
                                        <td class="py-3.5 px-4 text-slate-700 font-medium">100% of owner fee</td>
                    ...
                    <!-- Section 3: Match Challenges -->
                    <section id="challenge-refunds" class="legal-card p-6 sm:p-8">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h2 class="text-xl sm:text-2xl font-bold text-slate-900">50/50 Match Challenge Refund Rules</h2>
                        </div>
                        <div class="space-y-4 text-slate-600 text-sm sm:text-base leading-relaxed">
                            <div class="border-l-4 border-emerald-500 pl-4 py-1">
                                <h4 class="font-bold text-slate-900">1. Open / Pending Challenges (<span class="text-emerald-700">100% Refundable</span>)</h4>
                                <p class="text-sm text-slate-600 mt-1">
                                    If you create an open public challenge or send a direct team challenge and cancel before any opponent has accepted and paid, you receive a full 100% refund immediately back to your ArenaReserve wallet.
                                </p>
                            </div>
                            <div class="border-l-4 border-amber-500 pl-4 py-1">
                                <h4 class="font-bold text-slate-900">2. Accepted Match Challenges (<span class="text-amber-700">Escrow Locked</span>)</h4>
                                <p class="text-sm text-slate-600 mt-1">
                                    Once the opponent accepts and funds their 50% share, both teams have committed to the slot. The booking is marked as <code>challenge_accepted</code>. To prevent unilateral cancellations that strand opposing squads, automated single-party cancellation is disabled. If both teams agree to postpone or cancel due to mutual agreement, support will review and process refunds.
                                </p>
                            </div>
                        </div>
                    </section>

                    <!-- Section 4: Weather & Venue Faults -->
                    <section id="weather-refunds" class="legal-card p-6 sm:p-8">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h2 class="text-xl sm:text-2xl font-bold text-slate-900">Adverse Weather & Venue Unavailability</h2>
                        </div>
                        <div class="space-y-3 text-slate-600 text-sm sm:text-base leading-relaxed">
                            <p>
                                In scenarios where a match cannot proceed due to:
                            </p>
                            <ul class="list-disc pl-5 space-y-2">
                                <li>Heavy rain, waterlogging, or severe weather warnings on open turfs.</li>
                                <li>Venue floodlight generator failures or facility power outages.</li>
                                <li>Ground maintenance emergencies or double-booking by venue management.</li>
                            </ul>
                            <p>
                                Players are entitled to a <strong>100% full refund</strong> or a free reschedule voucher, validated upon notification to ArenaReserve support within 24 hours of the affected slot.
                            </p>
                        </div>
                    </section>

                    <!-- Section 5: Method & Timeline -->
                    <section id="method-timeline" class="legal-card p-6 sm:p-8">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h2 class="text-xl sm:text-2xl font-bold text-slate-900">Refund Methods & Settlement Timelines</h2>
                        </div>
                        <div class="grid sm:grid-cols-2 gap-4">
                            <div class="p-5 bg-emerald-50/50 rounded-2xl border border-emerald-200">
                                <span class="text-2xl">⚡</span>
                                <h4 class="font-bold text-emerald-900 text-base mt-2">In-App Wallet Refund</h4>
                                <p class="text-xs text-slate-600 mt-1 leading-relaxed">
                                    Instant balance update. Funds become immediately available for booking any other arena across the platform.
                                </p>
                            </div>
                            <div class="p-5 bg-slate-50 rounded-2xl border border-slate-200">
                                <span class="text-2xl">🏦</span>
                                <h4 class="font-bold text-slate-900 text-base mt-2">Bank / Easypaisa Reversal</h4>
                                <p class="text-xs text-slate-600 mt-1 leading-relaxed">
                                    Upon special request for account closure, manual bank withdrawals are audited and settled in 3 to 5 business days.
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section id="disputes" class="rounded-2xl bg-gradient-to-r from-emerald-800 to-teal-900 p-6 sm:p-8 text-white shadow-lg">
                        <div class="flex items-start gap-4">
                            <div class="w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center text-2xl flex-shrink-0">
                                💬
                            </div>
                            <div>
                                <h3 class="text-xl font-black text-white">Need Support With a Refund?</h3>
                                <p class="text-emerald-100 text-sm mt-1 leading-relaxed">
                                    Provide your <strong>Booking ID</strong>, registered email, and match date to our dedicated billing and refund support desk:
                                </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-10">
                ...
                <div class="md:col-span-3">
                    ...
                    <ul class="space-y-2.5 text-sm">
                        ...
                        <li><a href="refund-policy.php" class="text-emerald-400 font-semibold hover:underline">Refund Policy</a></li>
