                ...
                <div class="flex-shrink-0 flex items-center gap-1 sm:gap-2">
                    ...
                    <div class="relative">
                        <button id="profileDropdownBtn" onclick="toggleProfileDropdown()" class="flex items-center gap-2 hover:opacity-90 focus:outline-none transition-opacity" title="User Menu">
                            <div class="w-8 h-8 rounded-full overflow-hidden bg-emerald-600 text-white flex items-center justify-center font-bold text-sm flex-shrink-0">
                ...
                <?php foreach ($venues as $venue): ?>
                    <div class="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm flex flex-col justify-between">
                        ...
                        <div class="h-44 bg-slate-100 relative">
                            <?php 
                                $img_src = (!empty($venue['image_path']) && file_exists(__DIR__ . '/' . $venue['image_path'])) ? htmlspecialchars($venue['image_path']) : 'assets/images/placeholder.png';
                            ?>
                            <img src="<?php echo $img_src; ?>" alt="<?php echo htmlspecialchars($venue['title']); ?>" class="w-full h-full object-cover" onerror="this.onerror=null; this.src='assets/images/football.png';">
                            <!-- Status Badges -->
